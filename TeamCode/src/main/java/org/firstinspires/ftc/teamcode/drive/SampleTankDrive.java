...
public class SampleTankDrive extends TankDrive {
    ...
    public SampleTankDrive(HardwareMap hardwareMap) {
        ...
        DcMotorEx leftFront = hardwareMap.get(DcMotorEx.class, "0");
        DcMotorEx leftRear = hardwareMap.get(DcMotorEx.class, "2");
        DcMotorEx rightRear = hardwareMap.get(DcMotorEx.class, "3");
        DcMotorEx rightFront = hardwareMap.get(DcMotorEx.class, "1");
